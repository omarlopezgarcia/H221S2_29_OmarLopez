const url = "http://107.21.4.77:3000/api/pedido/";
let resultados = '';
...
const asuped = document.getElementById("ASUPED");
...
formArticulo.addEventListener('submit',
    (e) => {
   	 e.preventDefault();
   	 if (opcion == 'crear') {
   		 if (USERPED.value == "" || EMAUSPED.value == "" || CELUSPED.value == "" || ASUPED.value == "" || MSGPED.value == "") {
